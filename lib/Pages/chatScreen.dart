...
class ChatPageState extends State<ChatPage> {
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      chatProvider.sendMessage(content, type, groupChatId, currentUserId, widget.arguments.peerId,widget.arguments.peerNickname);
        ...
        return Row(
          children: <Widget>[
            ...
            // Text
              ...
              width: 200,
              decoration: BoxDecoration(color: AppColors.MainBGColor, borderRadius: BorderRadius.circular(8)),
              ...
              Row(
                children: <Widget>[
                  ...
                  messageChat.type == TypeMessage.text
                    ...
                    width: 200,
                    decoration:
                    BoxDecoration(color: AppColors.MainColor, borderRadius: BorderRadius.circular(8)),
  ...
  Widget buildInput() {
    return Container(
            ...
            child: Container(
              child: TextField(
                ...
                decoration: InputDecoration.collapsed(
                  ...
                  hintStyle: TextStyle(color: AppColors.MainBGColor),
                ),
                focusNode: focusNode,
                autofocus: true,
              ),
      ...
      height: 50,
      decoration: BoxDecoration(
          border: Border(top: BorderSide(color: AppColors.MainColor, width: 0.5)), color: Colors.white),
    );
  }
    ...
    return Flexible(
      child: groupChatId.isNotEmpty
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasData) {
            listMessage = snapshot.data!.docs.toList(); // Update listMessage here
